  ...
  <a-card :bordered="false">
      ...
      <a-row class="row-item-search">
        <a-form class="search-form" :form="searchForm" layout="inline" @submit="handleSearch">
          <a-form-item label="藏品名称">
            <a-input v-decorator="['goodsName']" placeholder="请输入藏品名称" />
          </a-form-item>
          <a-form-item label="藏品编码">
            <a-input v-decorator="['goodsNo']" placeholder="请输入藏品编码" />
          </a-form-item>
    ...
    >
      ...
      <div class="actions" slot="action" slot-scope="text, item">
        <router-link :to="{ path: '/fragments/update', query: { goodsId: item.goods_id } }">编辑</router-link>
...
export default {
  ...
  data () {
    return {
      ...
      loadData: param => {
        return GoodsApi.getSyn({ ...param, ...this.queryParam })
          .then(response => {
  ...
  methods: {
     ...
     */
    handleCreate () {
      this.$router.push('/fragments/create')
    },
