		...
		<a-spin :spinning="isLoading">
			<a-form :form="form" @submit="handleSubmit" :selfUpdate="true">
				<a-tabs :activeKey="tabKey" :tabBarStyle="{marginBottom: '30px'}" @change="handleTabs">
					...
					<!-- <a-tab-pane :key="3" tab="选择合成碎片"></a-tab-pane> -->
				</a-tabs>
				<div class="tabs-content">
					...
					<div class="tab-pane" v-show="tabKey == 0">
						...
						<a-form-item label="藏品分类" :labelCol="labelCol" :wrapperCol="wrapperCol">
							<a-tree-select placeholder="请选择藏品分类"
								:dropdownStyle="{ maxHeight: '500px', overflow: 'auto' }"
								:treeData="formData.categoryList" treeCheckable treeCheckStrictly allowClear
								v-decorator="['categorys', {rules: [{required: true, message: '请至少选择1个藏品分类'}]}]">
							</a-tree-select>
						...
						<a-form-item label="碎片列表" :labelCol="labelCol" :wrapperCol="wrapperCol">
						...
						<a-form-item label="藏品图片" :labelCol="labelCol" :wrapperCol="wrapperCol"
							extra="建议尺寸：750*750像素, 最多上传1张, 可拖拽图片调整顺序, 第1张将作为藏品首图">
                ...
                <span class="ml-10">千克 (Kg)</span>
					...
					<div class="tab-pane" v-show="tabKey == 3">
						<!-- <div style="width: 100%;height: 100%;padding: 20px 30px;display: flex;flex-wrap: wrap;">
							<div style="padding: 10px;" v-for="(item,index) in formData.debList">
								<div style="width: 80px;height: 80px;">
									<img style="width: 100%;height: 100%;" src="../../components/vc-tree/assets/icons.png"/></div>
									<div style="color: #000;">{{item.goods_name}}</div>
									<div>￥{{item.goods_price_min}}</div>
							</div>
						</div> -->
						<!-- <a-form-item
              label="主图视频"
