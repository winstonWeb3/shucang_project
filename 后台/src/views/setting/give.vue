  ...
  <a-card :bordered="false">
    ...
    <a-spin :spinning="isLoading">
      <a-form :form="form" @submit="handleSubmit">
		<a-form-item label="转赠时间" :labelCol="labelCol" :wrapperCol="wrapperCol">
		  <a-input-number v-model="qq" style="width: 200px"/>
		  <span class="ml-10">天</span>
		 <div class="form-item-help">
		    <p class="extra">注：天数请填写整数字0~100，例：10，即购买商品10天后可以进行转赠</p>
		  </div>
		</a-form-item>
...
export default {
  ...
  methods: {
    ...
    handleSubmit (e) {
        if(this.qq == ''){
			return this.$message.error('请填写转赠时间', 1.5)
		}
		Api.setGive({newday:this.qq})
		  .then((result) => {
		    // 显示提示信息
